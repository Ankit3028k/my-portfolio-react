    ...
    <div className="w-full bg-gray-900 flex justify-center items-center py-12">
      <div className="text-center w-full max-w-5xl px-4">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
          {experiences.map((exp) => (
            <div
              key={exp.year} // Using year as the unique key
              className="bg-[#1a1a1a] p-6 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300 transform hover:scale-105"
            >
